    ...
    def GreedyDriver(self, env, thres):
        ...
        for i in range(threshold, length):
            ...
            try:    #Finding the most rewarding action in the current state
                ...
                for a, v in actions.items():
                    if v in self.freq[env.mem_states[i]]:
                        freqs.append(self.freq[env.mem_states[i]][v] + 1)
                    else:
                        freqs.append(1)
            ...
            if _max == env.mem_action[i]:
                accuracy += 1
                self.freq[env.mem_states[i]][_max] += 1
...
# ------ birdstrikes1 -------
# 1 0.27, 0.27, 0.24, 0.26, 0.28, 0.29, 0.29, 0.38, 0.44
# 13 0.36, 0.34, 0.35, 0.29, 0.27, 0.29, 0.23, 0.25, 0.17
# 37 0.35, 0.32, 0.37, 0.32, 0.41, 0.35, 0.43, 0.24, 0.42
# 73 0.41, 0.42, 0.40, 0.36, 0.30, 0.23, 0.21, 0.33, 0.33
# 5 0.32, 0.30, 0.31, 0.35, 0.33, 0.31, 0.37, 0.32, 0.38
# 53 0.35, 0.35, 0.35, 0.32, 0.35, 0.35, 0.33, 0.36, 0.23
# 25 0.28, 0.32, 0.30, 0.31, 0.32, 0.29, 0.32, 0.24, 0.25
# 77 0.43, 0.36, 0.41, 0.42, 0.39, 0.39, 0.45, 0.51, 0.27
# 9 0.30, 0.31, 0.35, 0.30, 0.32, 0.28, 0.33, 0.25, 0.40
# 29 0.38, 0.32, 0.40, 0.30, 0.35, 0.32, 0.36, 0.37, 0.43
# 57 0.36, 0.34, 0.34, 0.32, 0.33, 0.25, 0.25, 0.24, 0.11
# 81 0.34, 0.25, 0.29, 0.31, 0.29, 0.35, 0.31, 0.31, 0.43
# 109 0.33, 0.40, 0.43, 0.41, 0.50, 0.51, 0.49, 0.41, 0.20
# 33 0.47, 0.51, 0.48, 0.46, 0.42, 0.39, 0.39, 0.35, 0.42
# 61 0.48, 0.49, 0.48, 0.42, 0.40, 0.39, 0.47, 0.57, 0.64
# 85 0.33, 0.17, 0.32, 0.31, 0.31, 0.31, 0.31, 0.50, 0.68
# 97 0.40, 0.36, 0.40, 0.37, 0.35, 0.33, 0.33, 0.28, 0.22

# Bayesian  0.36, 0.35, 0.36, 0.34, 0.35, 0.33, 0.35, 0.34, 0.35

# Action  0 0.41, 0.41, 0.42, 0.40, 0.40, 0.38, 0.44, 0.37, 0.32
# Action  1 0.28, 0.23, 0.26, 0.21, 0.23, 0.23, 0.21, 0.24, 0.30
# Action  2 0.32, 0.35, 0.33, 0.32, 0.30, 0.29, 0.23, 0.21, 0.11
# Action  3 0.07, 0.09, 0.05, 0.08, 0.08, 0.04, 0.03, 0.03, 0.02
# Action  4 0.11, 0.09, 0.12, 0.04, 0.05, 0.08, 0.04, 0.03, 0.01
...
# ------ faa1 -------
# 85 0.31, 0.38, 0.35, 0.42, 0.47, 0.47, 0.45, 0.33, 0.16
# 33 0.39, 0.39, 0.37, 0.35, 0.32, 0.31, 0.38, 0.41, 0.58
# 9 0.44, 0.45, 0.51, 0.42, 0.36, 0.29, 0.23, 0.36, 0.32
# 57 0.34, 0.27, 0.32, 0.26, 0.25, 0.31, 0.27, 0.12, 0.13
# 65 0.38, 0.39, 0.44, 0.37, 0.27, 0.31, 0.32, 0.28, 0.45
# 89 0.35, 0.41, 0.37, 0.44, 0.43, 0.45, 0.39, 0.52, 0.47
# 37 0.33, 0.30, 0.31, 0.36, 0.35, 0.30, 0.35, 0.26, 0.24
# 109 0.37, 0.35, 0.38, 0.40, 0.34, 0.36, 0.31, 0.36, 0.34
# 69 0.35, 0.36, 0.36, 0.33, 0.37, 0.36, 0.35, 0.35, 0.39
# 41 0.33, 0.34, 0.26, 0.31, 0.29, 0.25, 0.32, 0.24, 0.33
# 93 0.33, 0.37, 0.47, 0.46, 0.43, 0.39, 0.36, 0.53, 0.67
# 13 0.36, 0.28, 0.35, 0.36, 0.34, 0.29, 0.40, 0.42, 0.56
# 45 0.40, 0.35, 0.39, 0.41, 0.42, 0.45, 0.29, 0.38, 0.72
# 81 0.45, 0.43, 0.39, 0.43, 0.40, 0.25, 0.18, 0.17, 0.23
# 21 0.57, 0.63, 0.62, 0.62, 0.58, 0.67, 0.78, 0.86, 0.84
# Bayesian  0.38, 0.38, 0.39, 0.40, 0.38, 0.37, 0.36, 0.38, 0.43
# Action  0 0.45, 0.45, 0.47, 0.49, 0.45, 0.42, 0.43, 0.44, 0.44
# Action  1 0.27, 0.27, 0.28, 0.29, 0.28, 0.29, 0.25, 0.34, 0.13
# Action  2 0.36, 0.33, 0.37, 0.39, 0.38, 0.37, 0.19, 0.17, 0.05
# Action  3 0.10, 0.06, 0.08, 0.09, 0.09, 0.05, 0.03, 0.02, 0.00
# Action  4 0.11, 0.10, 0.13, 0.08, 0.09, 0.09, 0.11, 0.03, 0.04
