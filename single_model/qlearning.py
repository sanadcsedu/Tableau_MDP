...
if __name__ == "__main__":
    ...
    for d in datasets:
        ...
        for i, test_user_log in enumerate(tqdm(user_list)):
            ...
            trained_Q, best_alpha, best_eps, best_discount, training_accuracy = training(train_files, env, d, 'Qlearn', 1)
            X_train.append(training_accuracy)
            # test user
            test_files = [test_user_log]
            testing_accu = testing(test_files, env, trained_Q, best_alpha, best_eps, best_discount, d, 'Qlearn')
